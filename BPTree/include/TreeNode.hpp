...
public:
    ...
    TreePtr tree_ptr;
    uint size;
  //Stacks used for deletion..
stack<pair<TreePtr, int>> parentStack; //Parent_node , key_position
stack<pair<TreePtr, TreePtr>> siblingStack; // left_sibling , right_sibling
    ...
    virtual void delete_key(const Key& key, stack<pair<TreePtr, int>> parentStack
,stack<pair<TreePtr, TreePtr>> siblingStack
) {}
